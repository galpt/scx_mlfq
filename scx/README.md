...
### Wakeup boosts
Wakeups from a short sleep — up to 32 ms, the 60 Hz frame cadence — or from I/O get a rate-limited promotion to Q1, granted at most once per task every two milliseconds, so a bursty consumer of CPU such as a video decoder stays in Q1 for its whole burst.
